  ...
  return (
    <div data-testid="trust-accounts-page">
      <div className="flex items-center justify-between">
        ...
        <Link href="/trust/accounts/new" className="rounded-lg bg-blue-600 px-4 py-2 text-sm font-medium text-white hover:bg-blue-700 transition-colors" data-testid="new-trust-btn">New Account</Link>
      </div>
